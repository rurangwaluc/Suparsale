    ...
    <div className="app">
      ...
      >
        <div className="sidebar-logo">
          ...
          <span className="logo-text">Suparsale Store</span>
        ...
        <div className="sidebar-footer">
          <div className="sidebar-user">
            ...
            <div className="sidebar-user-text">
              ...
              <span>
                {user.role === "owner" ? "Owner account" : "Limited staff account"}
              </span>
            </div>
          </div>
        </div>
        ...
        <header className="header premium-header">
          ...
          <div>
            ...
            <div className="app-subtitle">
              {user.name} · {user.role === "owner" ? "Owner" : "Limited staff"}
            </div>
          </div>
          ...
          <div className="hdr-search app-header-search">
            ...
            <input
              type="text"
              placeholder="Search TVs, fridges, customers, debts..."
            />
          </div>
